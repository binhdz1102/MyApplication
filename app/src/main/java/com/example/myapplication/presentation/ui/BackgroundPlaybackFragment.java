...
import com.example.myapplication.databinding.FragmentBackgroundPlaybackBinding;
...
public class BackgroundPlaybackFragment extends Fragment {

    public static final String TAG = "BackgroundPlaybackFragment";
    ...
    private FragmentBackgroundPlaybackBinding binding;
    ...
    public View onCreateView(
        ...
        binding = FragmentBackgroundPlaybackBinding.inflate(inflater, container, false);
        ...
        if (screenConfigurationHost != null) {
            screenConfigurationHost.updateScreenConfiguration(
                    new ScreenConfiguration(
                            R.string.title_background_playback,
                            true,
                            false,
                            false
                    )
    ...
    private void updateControllerUi() {
        ...
        binding.textPlaylistStatusValue.setText(
                isPlaylistReady ? R.string.status_playlist_ready : R.string.status_playlist_empty
        );
        ...
        binding.buttonPlay.setEnabled(isConnected && hasSongs);
